          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=ICEB0003.php"><img src="https://images-na.ssl-images-amazon.com/images/I/51mjM9KHgBL._SX311_BO1,204,203,200_.jpg" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : Michigan manual of plastic surgery / David L. Brown, Gregory H. Borschel.</h4>
                  <h4>Author : David L Brown (David Lawrence), 1968- ; Gregory H Borschel</h4>
                  <h4>Subjects : Surgery, Plastic -- Handbooks, manuals, etc;
Electronic books</h4>
                  <h4>Date : 2004</h4>
                  <h4>Description: 1 online resource (442 pages) : illustrations. </h4>
                  <h4>Notes : Includes index. </h4>
                  <h4>Record number: 21182227350002061</h4>
