          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=ICEB0002.php"><img src="https://images-na.ssl-images-amazon.com/images/I/41HYnlLMoEL.jpg" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : Ballroom dancing with 100 diagrams and photographs of the quickstep, waltz, foxtrot, tango, etc. / Alex Moore ; foreword by Philip J.S. Richardson.</h4>
                  <h4>Author : Alex. Moore ProQuest (Firm) </h4>
                  <h4>Subjects : Ballroom dancing; <br>
                  Electronic books</h4>
                  <h4>Date : 2002</h4>
                  <h4>Description: xii, 308 p. : ill.. </h4>
                  <h4>Notes : "A Theatre arts book"--T.p. verso. </h4>
                  <h4>Record number: 21211295020002061</h4>
