    ...
    <body>
      ...
      <div id="frame">
        ...
        <div id="bookDetailsFrame">
          <div id="bookImageDiv">
                <a href="/bookdetail?page=ICB0002.php"><img src="https://images-na.ssl-images-amazon.com/images/I/41CDCtld9rL._SX331_BO1,204,203,200_.jpg" height="160px" width="160px"></img></a>
              </div>
              <div id="bookDetails">

                  <h4>Title : Microwave and Millimeter-Wave Electronic Packaging.</h4>
                  <h4>Author : Rick. Sturdivant</h4>
                  <h4>Subjects : Electronic books</h4>
                  <h4>Date : 2014</h4>
                  <h4>Description: 1 online resource (281 pages). </h4>
                  <h4>Notes : - </h4>
                  <h4>Record number: 21206550180002061 </h4>
