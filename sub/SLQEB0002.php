          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=SLQEB0002.php"><img src="https://images-na.ssl-images-amazon.com/images/I/51pkDNHCakL._SY344_BO1,204,203,200_.jpg" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : Managing Corporate Design Best Practices for In-House Graphic Design Departments</h4>
                  <h4>Author : Peter L. Phillips </h4>
                  <h4>Subjects : Business;
Leadership;
Management;
Electronic books </h4>
                  <h4>Date : 2015</h4>
                  <h4>Description: 1 online resource (310 p.). </h4>
                  <h4>Notes : Description based upon print version of record.  </h4>
                  <h4>Record number: 21167016010002061 </h4>
