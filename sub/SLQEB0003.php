          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=SLQEB0003.php"><img src="https://images-na.ssl-images-amazon.com/images/I/41Sj%2BbJOg0L._SX343_BO1,204,203,200_.jpg" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : Management / Brian Tracy.</h4>
                  <h4>Author : Brian Tracy </h4>
                  <h4>Subjects : Management;
Electronic books </h4>
                  <h4>Date : 2014</h4>
                  <h4>Description: 1 online resource (124 pages). </h4>
                  <h4>Notes : Includes bibliographical references and index. </h4>
                  <h4>Record number: 21182466050002061  </h4>
