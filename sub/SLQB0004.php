    ...
    <body>
      ...
      ?>
          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=SLQB0004.php"><img src="https://oup.com.pk/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/9/7/9780199060498_1.jpg" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title :Science</h4>
                  <h4>Author : Korean Overseas Information Service</h4>
                  <h4>Subjects : - </h4>
                  <h4>Date : 1973</h4>
                  <h4>Description: 95 p.;21cm.</h4>
                  <h4>Notes : - </h4>
                  <h4>Record number: 211268575300002061 </h4>
...
<!-- .php"><img src="https://images-na.ssl-images-amazon.com/images/I/41hZMu-cDnL._AC_US218_.jpg" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">
