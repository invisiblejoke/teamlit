          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=SLQB0002.php"><img src="http://t2.gstatic.com/images?q=tbn:ANd9GcS9vp0FP6aJVo4y8iG8hUiMGkVLFn5M3J-U_HaiRll5-duTgbWQ" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : Information communication technology at university : skills for success/Greg Shaw.</h4>
                  <h4>Author : Gregory.Shaw</h4>
                  <h4>Subjects : Information technology; Information technology -- Problems,exercise,etc</h4>
                  <h4>Date : 2010</h4>
                  <h4>Description: 229 p. : ill. ; 25cm. </h4>
                  <h4>Notes : Spiral binding.
Previous ed.:2009. </h4>
                  <h4>Record number: 21118303790002061 </h4>
