          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=SLQEB0004.php"><img src="https://global.oup.com/academic/covers/pop-up/9780195176797" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : A life worth living contributions to positive psychology / edited by Mihaly Csikszentmihalyi and Isabella Selega Csikszentmihalyi.</h4>
                  <h4>Author :  Mihaly Csikszentmihalyi ; Isabella Selega Csikszentmihalyi ; ebrary, Inc </h4>
                  <h4>Subjects : Positive psychology;
Electronic books </h4>
                  <h4>Date : 2006</h4>
                  <h4>Description: ix, 253 p. : ill.. </h4>
                  <h4>Notes : Includes bibliographical references and indexes. </h4>
                  <h4>Record number: 21184491860002061  </h4>
