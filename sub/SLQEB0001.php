          ...
          <div style="margin:20px;border:5px solid #000000">
            ...
            <div style="border-bottom:2px solid #000000;padding:20px;height:25em;margin-left:30px;">
              <div style="float:left;height:12em; margin-top:4em">
                <a href="/bookdetail?page=SLQEB0001.php"><img src="https://www.nap.edu/cover/9829/450" height="160px" width="160px"></img></a>
              </div>
              <div style="float:left;height:12em;margin-left:2em;margin-top:3em;">

                  <h4>Title : Information technology and the conduct of research the user's view/ report of the Panel on Information Technology and the Conduct of Research....[et al.].</h4>
                  <h4>Author : Panel on Information Technology and the Conduct of Research(U.S.) </h4>
                  <h4>Subjects : Information technology -- Scientific applications; Research -- Technologyical innovations; Electronic books </h4>
                  <h4>Date : 1989</h4>
                  <h4>Description: xiv, 76 p : col.ill.</h4>
                  <h4>Notes : Includes bibliographical references and index. </h4>
                  <h4>Record number: 21181215200002061 </h4>
