<html>
    ...
    <body>
      ...
      <img src="../img/StateLibraryLogo1.png" alt="logo" width="20%" style="margin-left:auto;margin-right:auto"/>
        </div>
		<!--end of header-->
		<!--start of search function-->
		<div class="navbar navbar-inverse navbar-static-top" style="background-color: transparent;">
			<div class="container" style="margin-left: unset;">
				<form action="../../includes/searchResult.php" method="post" class="navbar-form navbar-left" style="width:100%;padding:0">
					<table style="border:none;">
						<tbody>
							<tr>
								<td colspan="3" style="border:none;">
									<div class="row" style="float: left;">
										<select name="resourceType" style="padding-top: 5.5px;background-color: #e47f3b;margin-left: 15px;padding-bottom: 5.5px;width: 275px;font-size: 17px;color: white;margin-right: 10px;border-radius: 5px;">
							...
							<tr style="margin-bottom: 10px;float: left;">
								<td style="border:none;" colspan="3">
									<select name="itemType" style="padding-top: 0px;background-color: #e47f3b;padding-bottom: 0px;width: 150px;font-size: 17px;color: white;margin-right: 10px;border-radius: 5px;">
										<option value="Articles">Articles</option>
										<option value="Audio Visual">Audio Visual</option>
										<option value="Books">Books</option>
										<option value="Database titles">Database titles</option>
										...
										<option value="Web site titles">Web site titles</option>
										<option value="All items" selected="selected">All items</option>
									</select>
									<select name="phasing" style="padding-top: 0px;background-color: #e47f3b;padding-bottom: 0px;width: 260px;font-size: 17px;color: white;margin-right: 10px;border-radius: 5px;">
									...
									<select name="location" style="padding-top: 0px;background-color: #e47f3b;padding-bottom: 0px;width: 230px;font-size: 17px;color: white;margin-right: 10px;border-radius: 5px;">
